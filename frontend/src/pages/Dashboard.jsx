...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      {/* 1. HERO BANNER */}
      <div className="relative w-full rounded-2xl overflow-hidden shadow-sm h-64 md:h-56 flex flex-col justify-between">
        {/* Farm Background Image with solid Greenery overlay */}
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?q=80&w=1740&auto=format&fit=crop')] bg-cover bg-center"></div>
        ...
        <div className="relative z-10 p-6 md:p-8 flex flex-col md:flex-row md:items-end justify-between h-full">
          ...
          <form onSubmit={handleApplyParams} className="bg-white p-2 rounded-xl flex items-center gap-2 shadow-lg w-full md:w-auto overflow-x-auto">
